...
DEFAULT_TEXTS: dict[str, str] = {
    ...
    "earn": (
        "💸 <b>Заработать</b>\n\n"
        "Приглашай друзей по реферальной ссылке и получай звезды за каждого "
        "спонсора, на которого они подписались!\n\n"
        "🔹 Спонсоры Telegram: <b>{tg_reward} ⭐</b>\n"
        "🔹 Web спонсоры: <b>{web_reward} ⭐</b>\n\n"
        "<i>Для получения награды реферал должен подписаться на не менее "
        "{min_sponsors} спонсоров.</i>\n\n"
        "👑 <b>VIP система</b>\n"
        "При достижении {vip_threshold} рефералов вы получаете статус VIP, "
        "а после {top_tier} рефералов — дополнительные <b>+{top_bonus} ⭐</b> "
        "за каждого следующего!\n\n"

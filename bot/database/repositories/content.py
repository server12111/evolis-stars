...
DEFAULT_TEXTS: dict[str, str] = {
    "welcome": (
        ...
        "Здесь ты зарабатываешь RP⭐️ Stars: приглашай друзей, выполняй задания, "
    ...
    "earn": (
        ...
        "• 6+ спонсоров: <b>{referral_reward_above_5} RP⭐️</b>"
        "</blockquote>\n"
        ...
        "• 15 рефералов: +{bonus_15} RP⭐️\n"
        "• 20 рефералов: +{bonus_20} RP⭐️\n"
        "• 25 рефералов: +{bonus_25} RP⭐️\n"
        "• 30 рефералов: +{bonus_30} RP⭐️\n"
        "• 35 рефералов: +{bonus_35} RP⭐️\n"
        "• 40 рефералов: +{bonus_40} RP⭐️\n"
        "• 45 рефералов: +{bonus_45} RP⭐️\n"
        "• 50 рефералов: +{bonus_50} RP⭐️ и статус VIP! 🌟\n"
        "• 55 рефералов: +{bonus_55} RP⭐️\n"
        "• 60 рефералов: +{bonus_60} RP⭐️\n"
        "• 67 рефералов: +{bonus_67} RP⭐️\n"
        "• 70 рефералов: +{bonus_70} RP⭐️\n"
        "• 76 рефералов: +{bonus_76} RP⭐️\n"
        "• 80 рефералов: +{bonus_80} RP⭐️\n"
        "• 90 рефералов: +{bonus_90} RP⭐️"
        "</blockquote>\n\n"
        "🚀 После 100 рефералов вы продолжаете получать <b>+{top_bonus} RP⭐️</b> "

...
DEFAULT_TEXTS: dict[str, str] = {
    ...
    "earn": (
        ...
        "• 4-5 спонсоров: <b>{referral_reward_4_5} RP⭐️</b>\n"
        "• 6-7 спонсоров: <b>{referral_reward_6_7} RP⭐️</b>\n"
        "• 8-9 спонсоров: <b>{referral_reward_8_9} RP⭐️</b>\n"
        "• 10-12 спонсоров: <b>{referral_reward_10_12} RP⭐️</b>\n"
        "• 13+ спонсоров: <b>{referral_reward_13_16} RP⭐️</b>"
        "</blockquote>\n"

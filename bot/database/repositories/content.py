...
DEFAULT_TEXTS: dict[str, str] = {
    "welcome": (
        ...
        "Здесь ты зарабатываешь ⭐ Stars: приглашай друзей, выполняй задания, "
    ...
    "earn": (
        ...
        "<blockquote>"
        "• 3 спонсора: <b>{referral_reward_3} ⭐</b> (<b>{referral_reward_3_premium} ⭐</b> 💎)\n"
        "• 4 спонсора: <b>{referral_reward_4} ⭐</b> (<b>{referral_reward_4_premium} ⭐</b> 💎)\n"
        "• 5+ спонсоров: <b>{referral_reward_5} ⭐</b> (<b>{referral_reward_5_premium} ⭐</b> 💎)"
        "</blockquote>\n"
        "💎 — реферал с Telegram Premium\n\n"
        ...
        "• 15 рефералов: +{bonus_15} ⭐\n"
        "• 20 рефералов: +{bonus_20} ⭐\n"
        "• 25 рефералов: +{bonus_25} ⭐\n"
        "• 30 рефералов: +{bonus_30} ⭐\n"
        "• 35 рефералов: +{bonus_35} ⭐\n"
        "• 40 рефералов: +{bonus_40} ⭐\n"
        "• 45 рефералов: +{bonus_45} ⭐\n"
        "• 50 рефералов: +{bonus_50} ⭐ и статус VIP! 🌟\n"
        "• 55 рефералов: +{bonus_55} ⭐\n"
        "• 60 рефералов: +{bonus_60} ⭐\n"
        "• 67 рефералов: +{bonus_67} ⭐\n"
        "• 70 рефералов: +{bonus_70} ⭐\n"
        "• 76 рефералов: +{bonus_76} ⭐\n"
        "• 80 рефералов: +{bonus_80} ⭐\n"
        "• 90 рефералов: +{bonus_90} ⭐"
        "</blockquote>\n\n"
        "🚀 После 100 рефералов вы продолжаете получать <b>+{top_bonus} ⭐</b> "
    ...
    "bonus": (
        ...
        "Раз в 24 часа забирай случайный бонус от <b>{bonus_min} ⭐</b> до "
        "<b>{bonus_max} ⭐</b> — просто заходи и жми кнопку ниже."
    ),
    "tasks": (
        "📋 <b>Задания</b>\n\n"
        "Подписывайся на каналы и выполняй простые задания — за каждое "
        "получаешь <b>{tasks_reward} ⭐</b>."
    ),
    "games": (
        "🎮 <b>Игры</b>\n\n"
    ...
    "top": (
        "🏆 <b>Топ игроков</b>\n\n"
        "Лидеры по количеству рефералов и по балансу ⭐ — выбери рейтинг:"
    ),
    "tos": (

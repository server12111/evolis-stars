...
async def _render_wall(callback: CallbackQuery, session: AsyncSession, chat: Chat) -> None:
    ...
    text = (
        f"🚧 <b>Спонсор-стена</b>\n\n"
        f"Пока участник не подпишется на всех активных спонсоров ниже, бот удаляет его сообщения "
        f"в этом чате. Стена включается, если добавлен хотя бы один свой спонсор ИЛИ включены "
        f"платные спонсоры — необязательно и то, и другое.\n\n"
